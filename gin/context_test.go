...
import (
	...
	"github.com/imajinyun/goframe/gin/binding"
	testdata "github.com/imajinyun/goframe/gin/testdata/protoexample"
)
...
func TestContextHandlerNames(t *testing.T) {
	...
	for _, name := range names {
		assert.Regexp(t, `^(.*/vendor/)?(github\.com/imajinyun/gogin/pkg/core/gin\.){1}(TestContextHandlerNames\.func.*){0,1}(handlerNameTest.*){0,1}`, name)
	}
}
